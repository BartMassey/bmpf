...
\subsubsection{Correctness of the Optimal Algorithm}
  ...
  \begin{definition}
    ...
    distributions} is defined by $$
      U_n(a,b) = \{ \langle S, \frac{1}{|{[a\ldots b]}^n|~|~S \in {[a\ldots b]}^n \}
    $$
  \end{definition}
